...
This repository captures my CSCE 636 project on predicting the m-height of linear codes directly from generator matrices. The aim is to replace the slow LP-based solver with a deep model that can deliver a good accuracy in a fraction of the time. I just dumped everything here. I didn't clean it, I may create an another one more clean later.
