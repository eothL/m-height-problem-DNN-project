...
if __name__ == '__main__':
    ...
    LEARNING_RATE = 0.0063 # From previous best trial
    WEIGHT_DECAY = 5.8e-5  # From previous best trial
    BASE_CH = 32           # From previous best trial
    NUM_BLOCKS = 4         # From previous best trial
    ...
    # --- Instantiate Model ---
    print("\n--- Initializing standard ReLU-ResNet ---")
    ...
    model_name = "ReLU_ResNet_ViolationLoss"
