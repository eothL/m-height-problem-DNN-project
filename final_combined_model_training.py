...
# ==============================================================================
# === Model Definition (SE-ResNet with Lower Bound Enforcement) ===
# ==============================================================================
...
class ResNet2DWithParamsSE(nn.Module):
    def __init__(self, k_max=6, nk_max=6, n_params=3, base_ch=32, num_blocks=3, reduction=16, enforce_lower_bound=False):
        super().__init__()
...
if __name__ == '__main__':
    ...
    # --- Instantiate Model with Best Params and Lower Bound Enforcement ---
    print("\n--- Initializing SE-ResNet with Lower Bound and Violation Loss ---")
    ...
    model_name = "SE_ResNet_LowerBound_ViolationLoss"
